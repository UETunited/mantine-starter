...
import limeTravel from "../../assets/images/lime-travel.png";
import limeCanoeing from "../../assets/images/lime-canoeing.png";
import limeMessageSent from "../../assets/images/lime-message-sent.png";
        ...
        <Grid>
          <Grid.Col xs={12} sm={4} md={4} lg={4}>
            <Card shadow="sm" padding="lg" style={{ height: "100%" }}>
              <Card.Section>
                <Image src={limeTravel} alt={"sample1"} />
              </Card.Section>
